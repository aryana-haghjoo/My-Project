...
def mcmc(fun_chisq, start_guess, data, Ninv, nstep, dev):
    #definig the chain
...
#%%
#Running the MCMC
params, cs, acceptance_ratio = mcmc(chisquare, value, model_e, Ninv, nstep, dev)
#np.savetxt('params.gz' , params)
np.savetxt('/scratch/o/oscarh/aryanah/mcmc_simple/params.gz' , params)

#np.savetxt('csq.gz' , cs)
np.savetxt('/scratch/o/oscarh/aryanah/mcmc_simple/csq.gz' , cs)
...
txt = open('/scratch/o/oscarh/aryanah/mcmc_simple/results.txt','w')
...
plt.savefig('/scratch/o/oscarh/aryanah/mcmc_simple/mcmc_result.png')
...
plt.savefig('/scratch/o/oscarh/aryanah/mcmc_simple/chi_square.png')
...
plt.savefig('/scratch/o/oscarh/aryanah/mcmc_simple/parameters.png') 
...
plt.savefig('/scratch/o/oscarh/aryanah/mcmc_simple/fourier.png')
...
plt.savefig('/scratch/o/oscarh/aryanah/mcmc_simple/corner_plots.png')