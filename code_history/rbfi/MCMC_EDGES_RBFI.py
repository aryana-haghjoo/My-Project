...
start_guess = {'pop_rad_yield_0_': 2.82055313e+03, 'pop_rad_yield_1_': 1E38, 'pop_rad_yield_2_': 1E4, 'clumping_factor': 1}
...
nstep = 10000000 #number of steps to be taken in the MCMC
...
np.savetxt('/scratch/o/oscarh/aryanah/rbfi_output/mcmc_params.gz' , params)
...
#np.savetxt('ps.gz' , ps)
np.savetxt('/scratch/o/oscarh/aryanah/rbfi_output/ps.gz' , params)
