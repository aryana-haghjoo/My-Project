...
nstep = 5000 #number of steps to be taken in the MCMC
...
#np.savetxt('ps.gz' , ps)
np.savetxt('/scratch/o/oscarh/aryanah/output_2/ps.gz' , ps)
...
txt_2=open('/scratch/o/oscarh/aryanah/output_2/mcmc_result.txt','w')
