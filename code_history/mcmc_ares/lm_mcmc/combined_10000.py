...
plt.legend()
#plt.savefig('/scratch/o/oscarh/aryanah/output_3/guess_model.png')
...
np.savetxt('/scratch/o/oscarh/aryanah/output_3/params.gz' , params)
...
#np.savetxt('ps.gz' , ps)
np.savetxt('/scratch/o/oscarh/aryanah/output_3/ps.gz' , ps)
...
txt_2=open('/scratch/o/oscarh/aryanah/output_3/mcmc_result.txt','w')
...
plt.savefig('/scratch/o/oscarh/aryanah/output_3/mcmc_result.png')
plt.show()
...
plt.savefig('/scratch/o/oscarh/aryanah/output_3/chi-square.png')
plt.show()
...
plt.savefig('/scratch/o/oscarh/aryanah/output_3/parameters.png')
plt.show()    
...
plt.savefig('/scratch/o/oscarh/aryanah/output_3/fourier.png')
plt.show()    
...
plt.savefig('/scratch/o/oscarh/aryanah/output_3/corner_plots.png')
plt.show()
