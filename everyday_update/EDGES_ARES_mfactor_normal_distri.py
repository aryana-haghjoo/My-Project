#remember to check the fX limits, it can go above 1!
import ares
...
start_guess = {'multiplication_factor': 5, 'fstar': 0.02, 'fX': 0.9, 'fesc':0.1, 'clumping_factor':0.1, 'cX' : 4.89} #Do not change the key to multplication factor or change the run_ares function respectively
...
dev = [0.002, 0.0004, 0.002, 0.002, 0.002, 0.002]
...
nstep = 20000 #number of steps to be taken in the MCMC
